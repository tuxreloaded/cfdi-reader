...
// Generado el: 2025.05.20 a las 03:39:45 PM CST 
//


package mx.sat.cfdi.xsd;
...
public class Nomina {
    ...
    @XmlElement(name = "Receptor", namespace = "http://www.sat.gob.mx/nomina12", required = true)
    ...
    public static class Deducciones {
        ...
        @XmlElement(name = "Deduccion", namespace = "http://www.sat.gob.mx/nomina12", required = true)
    ...
    public static class Incapacidades {
        ...
        @XmlElement(name = "Incapacidad", namespace = "http://www.sat.gob.mx/nomina12", required = true)
    ...
    public static class OtrosPagos {
        ...
        @XmlElement(name = "OtroPago", namespace = "http://www.sat.gob.mx/nomina12", required = true)
    ...
    public static class Percepciones {
        ...
        @XmlElement(name = "Percepcion", namespace = "http://www.sat.gob.mx/nomina12", required = true)
    ...
    public static class Receptor {
        ...
        @XmlElement(name = "SubContratacion", namespace = "http://www.sat.gob.mx/nomina12")
